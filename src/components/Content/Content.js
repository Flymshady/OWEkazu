    ...
    render() {
        return (
            ...
            <div className={'Content FlexCenter'}>
                ...
                <div className={"card"}>
                    <img src="https://image.flaticon.com/icons/svg/1877/1877771.svg" alt="" className={'w100'}></img>
                ...
                <div className={"card"}>
                    <img src="https://image.flaticon.com/icons/svg/1875/1875640.svg" alt="" className={'w100'}></img>
                    <div className={"container"}>
                        <h4><b>Vyučující</b></h4>
